...
class Expr:
    ...
    def __add__(self, rhs):
        ...
        from mkc.operations import Literal
        return Add(self, Literal.expr_or_loteral(rhs))

    def __sub__(self, rhs):
        from mkc.operations import Sub
        from mkc.operations import Literal
        return Sub(self, Literal.expr_or_loteral(rhs))

    def __mul__(self, rhs):
        from mkc.operations import Mul
        from mkc.operations import Literal
        return Mul(self, Literal.expr_or_loteral(rhs))

    def __div__(self, rhs):
        from mkc.operations import Div
        from mkc.operations import Literal
        return Div(self, Literal.expr_or_loteral(rhs))
